# From: https://github.com/StableCoder/cmake-scripts#sanitizer-builds-sanitizerscmake
    ...
    if(UNIX)
        ...
        if(USE_SANITIZER MATCHES "([Ll]eak)")
            ...
            if (SANITIZER_LEAK_AVAILABLE)
                ...
                message(FATAL_ERROR "Leak sanitizer not available for ${CMAKE_CXX_COMPILER}")
            endif()
        endif()
